...
public class MainActivity extends AppCompatActivity {
    ...
    String checked8 = answer8.getText().toString();
     ...
     public void grading(int score){
       if(score>8){
         toast =Toast.makeText( context,getString(R.string.result)+score+getString(R.string.review),Toast.LENGTH_SHORT);
         toast.show();
         }
       else if(score>6){
           toast =Toast.makeText( context,getString(R.string.result2)+score+getString(R.string.review),Toast.LENGTH_SHORT);
           toast.show();

       }
       else if(score>4){
       toast =Toast.makeText( context,getString(R.string.result3)+score+getString(R.string.review),Toast.LENGTH_SHORT);
       toast.show();
       }
       else if(score>0){
        toast =Toast.makeText( context,getString(R.string.result4)+score+getString(R.string.review),Toast.LENGTH_SHORT);
        toast.show();
